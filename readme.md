...
---
### Usage:
This proof of concept focuses on usage of airflow v.3.x on premise to orchestrate a pyspark data pipeline. Before running, populate your settings in `dags\config.py`. 
